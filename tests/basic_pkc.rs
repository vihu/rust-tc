// This is the exact same test as done in the original (now defunct) repo by poanetwork to ensure API adherence
// https://github.com/poanetwork/threshold_crypto/blob/master/examples/basic_pkc.rs

use rust_tc::{PublicKey, SecretKey, Signature};
